    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center font-sans px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-white text-2xl font-bold mt-6">Crie sua conta de Aluno</h1>
          <p className="text-slate-400 text-sm mt-2">Acesse cursos, aplicações e muito mais.</p>
        </div>
          ...
          <form className="space-y-5" noValidate>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-3 text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
              />
            </div>
            ...
            <div>
              ...
              <input
                id="cadastro-aluno-senha-confirm"
                type="password"
            ...
            <div className="flex items-start gap-3">
              <input
                id="cadastro-aluno-termos"
                type="checkbox"
                className="mt-1 w-4 h-4 accent-indigo-600 rounded"
              />
              <label htmlFor="cadastro-aluno-termos" className="text-slate-400 text-sm">
                Concordo com os{' '}
            ...
            {/* Botão */}
            <button
              id="cadastro-aluno-submit"
              type="submit"
              className="w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold text-sm hover:bg-indigo-500 transition-all shadow-lg hover:shadow-indigo-500/20"
            >
              Criar Minha Conta
            </button>
            ...
            <button type="button" className="w-full bg-white text-slate-800 py-3 rounded-lg font-semibold text-sm hover:bg-slate-100 transition flex items-center justify-center gap-3">
        ...
        <p className="text-center text-slate-500 text-sm mt-6">
          ...
          {' '}· É um criador?{' '}
          <Link href="/cadastro-professor" className="text-cyan-400 hover:text-cyan-300 font-medium transition">Cadastre-se aqui</Link>
        </p>
      </div>
    </div>
  );
